...
(function (name, context, factory) {
  ...
  if (typeof module !== "undefined" && module.exports) {
    module.exports = factory(require("heatmap.js"), require("google-maps"));
    ...
    if (typeof window.h337 === "undefined") {
      throw new Error(
        "heatmap.js must be loaded before the gmaps heatmap plugin"
      );
    }
    if (typeof window.google === "undefined") {
      throw new Error(
        "Google Maps must be loaded before the gmaps heatmap plugin"
      );
    }
  ...
  HeatmapOverlay.prototype.draw = function () {
    ...
    this.container.style[HeatmapOverlay.CSS_TRANSFORM] =
